...
DISCORD_UNPROMPTED_IDLE_MINUTES = _float_secret("DISCORD_UNPROMPTED_IDLE_MINUTES", 10.0)
...
LLAMA_BATCH_SIZE = _int_secret("LLAMA_BATCH_SIZE", 512 if IS_RASPBERRY_PI else 1024)
LLAMA_UBATCH_SIZE = _int_secret("LLAMA_UBATCH_SIZE", min(128 if IS_RASPBERRY_PI else 512, LLAMA_BATCH_SIZE))
...
LLAMA_IDLE_UNLOAD_SECONDS = _float_secret("LLAMA_IDLE_UNLOAD_SECONDS", 0.0)
