...
LLAMA_WARMUP_STATIC_PROMPT = _bool_secret(
...
MEMORY_CONTEXT_TOKENS = max(32, _int_secret("MEMORY_CONTEXT_TOKENS", 160))
...
MEMORY_MIN_RELEVANCE = max(
    0.0,
    min(1.0, _float_secret("MEMORY_MIN_RELEVANCE", 0.18)),
)
MEMORY_MIN_SCORE = max(0.0, min(1.0, _float_secret("MEMORY_MIN_SCORE", 0.34)))
MEMORY_RELEVANCE_WEIGHT = max(0.0, _float_secret("MEMORY_RELEVANCE_WEIGHT", 0.55))
MEMORY_IMPORTANCE_WEIGHT = max(0.0, _float_secret("MEMORY_IMPORTANCE_WEIGHT", 0.12))
MEMORY_CONFIDENCE_WEIGHT = max(0.0, _float_secret("MEMORY_CONFIDENCE_WEIGHT", 0.14))
MEMORY_RECENCY_WEIGHT = max(0.0, _float_secret("MEMORY_RECENCY_WEIGHT", 0.08))
MEMORY_CONTINUITY_WEIGHT = max(0.0, _float_secret("MEMORY_CONTINUITY_WEIGHT", 0.08))
